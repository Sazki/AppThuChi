...
class ReportMonthFragment : Fragment() {
    ...
    class MultiLineXAxisRenderer(
        ...
        override fun drawLabel(
            ...
            for (i in lines.indices) {
                // Vẽ từng dòng, dòng sau thấp hơn dòng trước
    ...
    private fun setupChartStyle() {
        ...
        // Tăng khoảng trống dưới đáy để chứa đủ 2 dòng chữ
        barChart.extraBottomOffset = 30f

        // --- 3. ÁP DỤNG BỘ VẼ MỚI VÀO BIỂU ĐỒ ---
    ...
    private fun observeData() {
        ...
        viewModel.categoryLabels.observe(viewLifecycleOwner) { labels ->
            // Áp dụng hàm xuống dòng cho từng nhãn
